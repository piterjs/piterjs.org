...
(function ($) {
    let $piterjs_speaker_snippet = (() => {
        ...
        return $piterjs_speaker_snippet;
    })();
...
(function ($) {
    let $piterjs_app = (() => {
        class $piterjs_app extends $.$mol_view {
            ...
            theme(val, force) {
                return (val !== void 0) ? val : "$mol_theme_auto";
            }
            sub() {
            ...
            Now() {
                return ((obj) => {
                    obj.place = () => this.place();
                    obj.lights = (val) => this.lights(val);
                    return obj;
...
(function ($) {
    let $piterjs_now = (() => {
        class $piterjs_now extends $.$mol_page {
            ...
            Lights() {
                return ((obj) => {
                    ...
                    obj.hint = () => "Переключатель света";
                    obj.checked = (val) => this.lights(val);
                    return obj;
        ...
        __decorate([
            $.$mol_mem
        ], $piterjs_now.prototype, "Lights_icon", null);
        __decorate([
            $.$mol_mem
        ], $piterjs_now.prototype, "lights", null);
        __decorate([
